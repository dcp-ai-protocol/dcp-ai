...
**Validation:** `dcp validate <schema> <json>`, `dcp validate-bundle <bundle.json>`, `dcp verify-bundle <signed.json> <public_key.txt>`.  
**Conformance:** `npm run conformance` validates L3-OBJECTS + L3-BUNDLE + L3-SIGNED.
