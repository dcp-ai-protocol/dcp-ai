#!/usr/bin/env node
/**
 * @dcp-ai/create-langchain — scaffolds a DCP-governed LangChain project.
 *
 * Usage:
 *   npm create @dcp-ai/langchain my-app
 *   npx @dcp-ai/create-langchain my-app
 */
import fs from 'node:fs';
import path from 'node:path';
import { fileURLToPath } from 'node:url';

const TEMPLATE_NAME = 'langchain';
...
console.log(`Docs: https://docs.dcp-ai.org/quickstart/QUICKSTART_LANGCHAIN/`);
