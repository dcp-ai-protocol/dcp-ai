#!/usr/bin/env node
/**
 * @dcp-ai/create-openai — scaffolds a DCP-governed LangChain project.
 *
 * Usage:
 *   npm create @dcp-ai/openai my-app
 *   npx @dcp-ai/create-openai my-app
 */
import fs from 'node:fs';
import path from 'node:path';
import { fileURLToPath } from 'node:url';

const TEMPLATE_NAME = 'openai';
...
console.log(`Docs: https://docs.dcp-ai.org/quickstart/QUICKSTART_OPENAI/`);
