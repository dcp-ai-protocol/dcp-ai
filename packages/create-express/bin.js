#!/usr/bin/env node
/**
 * @dcp-ai/create-express — scaffolds a DCP-governed LangChain project.
 *
 * Usage:
 *   npm create @dcp-ai/express my-app
 *   npx @dcp-ai/create-express my-app
 */
import fs from 'node:fs';
import path from 'node:path';
import { fileURLToPath } from 'node:url';

const TEMPLATE_NAME = 'express';
...
console.log(`Docs: https://docs.dcp-ai.org/quickstart/QUICKSTART_EXPRESS/`);
